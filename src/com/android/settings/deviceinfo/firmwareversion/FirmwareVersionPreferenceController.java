...
import static com.android.settings.deviceinfo.firmwareversion.ZAPVersionPreferenceController.ZAP_PROP;
...
public class FirmwareVersionPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        final String romVersion = SystemProperties.get(ZAP_PROP, versionDef);
